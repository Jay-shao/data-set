...
void dataSetEndCallback(const std_msgs::Bool &msg)
{
    endFlag = msg.data;
}
...
int main(int argc, char** argv)
{
    ...
    ros::NodeHandle nh;
    ros::Publisher dataSetFlag_ = nh.advertise<std_msgs::Bool>("/data_set_flag", 1, true);
    ros::Subscriber dataSetEndFlag_ = nh.subscribe("/data_set_end_flg", 1, &dataSetEndCallback);
    ...
    while(goal_number && endFlag)    // total is 4 goals
    {
